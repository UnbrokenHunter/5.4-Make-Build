	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 texCoord10 = v.texcoord;
				texCoord10.xy = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult31 = (float2(texCoord10.z , texCoord10.w));
				float mulTime8 = _TimeParameters.x * _Noise;
				float2 uv_OffsetTexture = v.texcoord.xy * _OffsetTexture_ST.xy + _OffsetTexture_ST.zw;
				...
				float3 vertexValue = float3( ( ( _Scale * ( appendResult31 * sin( mulTime8 ) ) ) * tex2Dlod( _OffsetTexture, float4( uv_OffsetTexture, 0, 0.0) ).r ) ,  0.0 );
						 ...
						 ) : SV_Target
			{
				...
				float3 BaseColor = ( _Emissive * ( IN.ase_color * tex2DNode1 ) ).rgb;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				texCoord10.xy = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult31 = (float2(texCoord10.z , texCoord10.w));
				float mulTime8 = _TimeParameters.x * _Noise;
				float2 uv_OffsetTexture = v.ase_texcoord.xy * _OffsetTexture_ST.xy + _OffsetTexture_ST.zw;
...
/*ASEBEGIN
Version=19002
66;639;1496;513;778.5569;169.9332;1.3;True;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-1066.039,-240.9032;Inherit;True;Property;_MainTex;Main Tex;0;0;Create;True;0;0;0;False;0;False;-1;2582528002278f141bceb6a96817875c;2582528002278f141bceb6a96817875c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;27;-316.3536,173.7483;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;42;6;27;0
WireConnection;42;8;33;0
ASEEND*/
//CHKSM=1B0A5F8A3FB81536A762866595A2FF94A27FE349